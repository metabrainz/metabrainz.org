...
from metabrainz.model import db, OAuth2Client, OAuth2AccessToken, OAuth2RefreshToken
...
class RefreshGrantTestCase(OAuthTestCase):
    ...
    def test_oauth_token_refresh_retains_original_scope(self):
        ...
        self.assertSetEqual({"profile", "musicbrainz:tag"}, {s.name for s in refresh_token.scopes})
